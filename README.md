# AFTER MIDNIGHT — 深夜玩家名片展示館

> **正式版** → https://aftermidnight-gg.vercel.app

鬥陣特工（Overwatch 2）主題的玩家身份展示系統。建立你的遊戲人格卡片，展示本命英雄、段位與遊戲氣質；其他玩家安靜地探索、收藏，再自行決定是否透過遊戲內好友系統接觸——低侵入社交（Low-intrusive Social）。

## 功能

- 🎮 **個人名片**：選英雄（最多 3 位）、設定段位、標籤、留言、MBTI、通訊管道
- 🌸 **卡片廣場**：玩家卡片展示牆，依遊戲/伺服器/定位/語音過濾，安靜探索
