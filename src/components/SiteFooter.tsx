...
export default function SiteFooter() {
  ...
  return (
    <footer className="site-footer fluid-gap-footer border-t border-white/[0.03] px-4 py-10 text-center text-[11px] relative z-10 bg-transparent sm:py-12">
      ...
      <p className="font-sans text-xs font-medium leading-6 tracking-[0.04em] text-theme-text-soft">
        AFTER MIDNIGHT • 給玩家放名片、看名片、慢慢找隊友的地方
      </p>
      <p className="mt-2 max-w-md mx-auto font-mono text-[11px] leading-relaxed text-theme-text-muted opacity-90">
            ...
            <Link
              ...
              className={`rounded-full border px-3 py-1.5 tracking-[0.16em] transition-all duration-300 ${
                isActive
                  ...
                  : "border-white/[0.06] bg-white/[0.02] text-theme-text-muted hover:border-auroraMint/30 hover:text-theme-text-body"
              }`}
            >
              {link.label}
            </Link>
