...
export default function FloatingDock() {
  ...
  return (
    <div className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 transition-all duration-300">
      {/* 鵝卵石圓潤磨砂玻璃 Dock - 手機端微縮與高透降噪處理 */}
      <div 
        className="relative px-4 sm:px-6 py-1.5 sm:py-2.5 rounded-full flex items-center gap-4 sm:gap-6 bg-white/25 sm:bg-white/35 backdrop-blur-3xl border border-white/40 sm:border-white/50 shadow-[0_8px_32px_rgba(74,62,61,0.02),_0_20px_50px_-10px_rgba(74,62,61,0.05)] h-[48px] sm:h-[58px] transition-all duration-300"
        ...
        {navItems.map((item, idx) => {
          ...
          return (
            ...
            >
              ...
              <div 
                className={`w-8.5 h-8.5 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl flex items-center justify-center transition-all duration-500 ${
                  isActive 
