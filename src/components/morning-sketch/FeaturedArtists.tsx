  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div
        ...
        style={{
          boxShadow: "0 10px 40px -10px rgba(var(--theme-accent-rgb, 140, 124, 108), 0.08)"
        }}
      >
        ...
        <div className="space-y-3">
          {events.map((event) => {
            ...
            const buttonClass = `flex min-w-[52px] cursor-pointer items-center justify-center gap-0.5 whitespace-nowrap rounded-lg border px-2 py-1 text-[8px] font-black uppercase tracking-widest transition-all duration-300 ${
              event.joined 
            ...
            return (
              ...
              >
                {/* 漸變底色 */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#82b7cc]/15 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
