...
export default function DevModeBanner() {
  ...
  return (
    <Link
      ...
      aria-label="進入開發者後台"
      title="進入開發者後台"
      className="fixed top-0 left-0 right-0 z-[100] w-full flex items-center justify-center gap-2 border-b border-auroraMint/20 bg-[#07040f]/90 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-theme-text-strong shadow-[0_0_22px_rgba(192,132,252,0.16)] backdrop-blur-md transition-all duration-300 hover:border-auroraMint/45 hover:bg-[#0b0914]/95 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-auroraMint/60 focus-visible:ring-offset-0"
    >
