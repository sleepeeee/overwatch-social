...
const sections = [
  ...
  },
  {
    title: "詐騙防範與第三方連結",
    items: [
      "我們永遠不會在站內、Email、私訊或任何站外管道，跟你要遊戲帳號密碼、雙重驗證碼、簡訊驗證碼、信用卡或銀行帳號、超商代碼，也不會跟你收任何錢。",
      "看到有人自稱 AFTER MIDNIGHT 的人員、客服或開發者，跟你要以上資訊，那就是詐騙。請馬上停止互動，並透過回報入口告訴我們。",
      "名片上的 Discord、Twitter / X、Instagram 等連結是玩家自己填的，我們不審查、不背書，也不對連結後的內容、安全性或可用性負責。",
      "點開離站連結之後的風險（釣魚網站、惡意程式、個資外洩等）由玩家自己承擔。",
    ],
  },
  {
    title: "站方管理權",
